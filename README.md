## 🛒 Тестирование интернет-магазина DemoShopping

Комплексное тестирование веб-приложения [DemoShopping](https://qa.demoshopping.ru), включающее подготовку тестовой документации, проведение тестов и фиксацию дефектов.

### 📋 Тест-план
- [Тест-план (Google Sheets)](https://docs.google.com/spreadsheets/d/1fKSAKYZ9HwlhFl9cI71caT5xIuuowwbp_0OLffXuH0s/edit?gid=0#gid=0) – описание целей, видов тестирования, стратегии и сроков
